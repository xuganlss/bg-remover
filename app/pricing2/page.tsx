// Pricing page with both one-time purchases and subscriptions
'use client';
...
const subscriptionPlans = [
  { 
    ...
    popular: false,
    planId: 'P-2CN37042J7272960HNHDUIBI'
  },
  { 
    name: 'Pro', 
    price: '$19.99', 
    ...
    popular: true,
    planId: 'P-18582952CE534212TNHDUIWQ'
  },
];
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="mb-12">
            <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl p-6 text-white mb-8">
              ...
              <p className="text-purple-100 text-sm">
                Manage your subscription and view credit history below.
              </p>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            <h2 className="text-2xl font-bold text-gray-800">💳 One-Time Purchase</h2>
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            <h2 className="text-2xl font-bold text-gray-800">🔄 Monthly Subscription</h2>
