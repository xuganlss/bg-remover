    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      <header className="border-b border-white/60 bg-white/70 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <span className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full font-medium">Free & No Signup</span>
        </div>
      </header>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-xl mx-auto">
            ...
            No signup. No watermarks. Download as transparent PNG.
          </p>
        </div>
